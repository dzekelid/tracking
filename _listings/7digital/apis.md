...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/7digital/apis.md
...
- name: 7digital Purchasing API - user/purchase/{purchaseid}/track/{trackid}
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/7digital/userpurchasepurchaseidtracktrackid-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/7digital/userpurchasepurchaseidtracktrackid-delete-openapi.md
- name: 7digital Purchasing API - user/purchase/{purchaseid}/track/{trackid}
  x-api-slug: userpurchasepurchaseidtracktrackid-delete
  description: This method allows a user to remove a purchase of a track from the
    sales report when the purchase has been refunded.
