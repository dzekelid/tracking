...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/bitly/apis.md
...
- name: Bitly User API User Tracking Domain List
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/bitly/v3usertracking-domain-list-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/bitly/v3usertracking-domain-list-get-openapi.md
- name: Bitly User API
  x-api-slug: bitly-user-api
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tracking/master/_listings/bitly/openapi.md
x-common:
- type: x--net-library
